...
LLIST *llist_create(int initSize)
{
    ...
    new = malloc(sizeof(struct llist_head_st));
    if (new == NULL)
        return NULL;
...
static struct llist_node_st *_find(struct llist_head_st *list, const void *key, llist_cmp *cmp)
{
    struct llist_node_st *cur;
